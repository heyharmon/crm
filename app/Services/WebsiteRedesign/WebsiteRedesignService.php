        ...
        DB::transaction(function () use ($organization, $result) {
            ...
            foreach ($result->events as $event) {
                $organization->websiteRedesigns()->create([
                    ...
                    'before_nav_class_count' => $event['before_nav_class_count'] ?? null,
                    'after_nav_class_count' => $event['after_nav_class_count'] ?? null,
                    'before_nav_classes' => $event['before_nav_classes'] ?? [],
                    'after_nav_classes' => $event['after_nav_classes'] ?? [],
